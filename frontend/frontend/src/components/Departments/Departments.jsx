                          ...
                          <li className="py-2 mb-1 border-bottom">
                            <a href="javascript:void(0);" className="d-flex">
                              ...
                              <div className="flex-fill ms-2">
                                ...
                                <span>Add New Project for App Developemnt</span>
                              </div>
                            </a>
                          </li>
                          <li className="py-2 mb-1 border-bottom">
                            <a href="javascript:void(0);" className="d-flex">
                              ...
                              <div className="flex-fill ms-2">
                                ...
                                <span>Add Timesheet For Rhinestone project</span>
                              </div>
                            </a>
                          </li>
                          <li className="py-2">
              ...
              <div className="dropdown user-profile ml-2 ml-sm-3 d-flex align-items-center">
                <div className="u-info me-2">
                  <p className="mb-0 text-end line-height-sm">
                    <span className="font-weight-bold">Prof. Dr. Barbaros Çetin</span>
                  </p>
            ...
            <div className="border-0 mb-4">
              <div className="card-header py-3 no-bg bg-transparent d-flex align-items-center px-0 justify-content-between border-bottom flex-wrap">
                ...
                <div className="col-auto d-flex w-sm-100">
                  ...
                  >
                    <i className="icofont-plus-circle me-2 fs-6"></i>Add Departments
                  </button>
                </div>
              </div>
            </div>
                      ...
                      <tr>
                        ...
                        <td>
                          <img
                            ...
                            alt=""
                          />
                          <span className="fw-bold ms-1">Cankutay Dündar</span>
                        </td>
                      ...
                      <tr>
                        ...
                        <td>
                          <img
                            ...
                            alt=""
                          />
                          <span className="fw-bold ms-1">Anıl Yeşil</span>
                        </td>
