// src/people/Coordinator/ImportOfferings.jsx
...
const ImportOfferings = () => {
  ...
  const handleUploadClick = async () => {
    ...
    try {
      ...
      const res = await fetch(`${BASE}/imp-offerings`, {
        method:  "POST",
        headers: hdrs,
        body:    form
      });
      ...
      showToast("Offerings imported successfully!", false);
      setFile(null);
      setFileName("");
      setExcelData([]);
    } catch (err) {
      ...
      <div className="container-fluid py-4">
        <div className="card shadow-sm border-0">
          <div className="card-body">
            <h4 className="fw-bold mb-4 text-primary">Import Offerings via Excel</h4>
            <div className="mb-3">
              ...
              <>
                <div className="d-flex justify-content-end mb-3">
                  <button
                    ...
                    disabled={uploading}
                  >
                    {uploading ? "Importing…" : "Import Offerings"}
                  </button>
                </div>
