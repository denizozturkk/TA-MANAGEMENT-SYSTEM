// src/people/Coordinator/ImportTAs.jsx
...
const API_UPLOAD  = "http://localhost:8080/api/coordinators/imp-ta";

export default function ImportTAs() {
  // selection + offering
  ...
  const showToast = (message, isError=false, timeout=4000) => {
    setToast({ show:true, message, isError });
    setTimeout(() => setToast(t=>({ ...t, show:false })), timeout);
  };

  // 1️⃣ load all course codes once
  useEffect(() => {
  ...
  // 4️⃣ upload to /imp-ta
  const handleUpload = async () => {
    if (!offeringId)   return showToast("Search and select an offering first", true);
    ...
    try {
      ...
      showToast("TAs imported successfully!", false);
      setFile(null);
      setFileName("");
      setExcelData([]);
    } catch(err) {
      ...
      <div className="container-fluid py-4">
        <div className="card shadow-sm border-0 mb-4">
          <div className="card-body">
            <h4 className="fw-bold mb-4 text-primary">Import TAs via Excel</h4>
              ...
              <>
                <div className="d-flex justify-content-end mb-3">
                  <button
                    ...
                    disabled={uploading}
                  >
                    {uploading ? "Importing…" : "Import TAs"}
                  </button>
                </div>
                <div
        ...
        >
          <div className="d-flex">
            <div className="toast-body">
              <strong>Bilkent TA Management System says:</strong>
