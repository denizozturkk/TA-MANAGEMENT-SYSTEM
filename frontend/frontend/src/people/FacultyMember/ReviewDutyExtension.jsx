...
const ReviewDutyExtension = () => {
  ...
  useEffect(() => {
    ...
    // Fetch TA list for mapping IDs → names
    ...
    fetch(
      ...
      .then((updated) => {
        setRequests((prev) =>
          prev.map((r) =>
            r.id === updated.id
              // Sadece status alanını güncelle, diğer tüm alanlar olduğu gibi kalsın
  ...
  return (
    <div className="d-flex">
      ...
      <div className="container py-4 flex-grow-1">
        <h3 className="fw-bold mb-4">Duty Extension Requests</h3>
                ...
                <div className="modal-content">
                  <div className="modal-header">
                    <h5 className="modal-title">
                      Respond to Request #{selectedReq.id}
                    </h5>
                    <button
                      type="button"
                      className="btn-close"
                  ...
                  <div className="modal-body">
                    ...
                    <p>
                      ...
                      {selectedReq.requestedExtensionDays}
                    </p>
                    <p>
                      <strong>Requested At:</strong>{" "}
                      {new Date(selectedReq.requestedAt).toLocaleString()}
                    </p>
                    <p>
                      <strong>Excuse Type:</strong> {selectedReq.excuseType}
                    </p>
