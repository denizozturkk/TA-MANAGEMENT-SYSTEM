        ...
        <ul className="menu-list flex-grow-1 mt-3">
          ...
          <li className="collapsed">
            ...
            <ul className="sub-menu collapse" id="client-Components">
              <li><a className="ms-link" href="ourclients.html"><span>Generate Classroom List </span></a></li>
              <li><a className="ms-link" href="profile.html"><span>Print Student Distribition</span></a></li>
              <li><a className="ms-link" href="profile.html"><span>Print Student Distribition</span></a></li>
              <li><a className="ms-link" href="profile.html"><span>Review Ta Leave Request</span></a></li>
              <li><a className="ms-link" href="profile.html"><span>Select Assignment Type </span></a></li>
              <li><a className="ms-link" href="profile.html"><span>Upload Semester Excel Data </span></a></li>
