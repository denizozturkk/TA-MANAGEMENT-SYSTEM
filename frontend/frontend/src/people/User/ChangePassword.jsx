                ...
                <div className="w-100 p-3 p-md-5 card border-0 bg-dark text-light" style={{ maxWidth: '32rem' }}>
                  <form onSubmit={handleSubmit} className="row g-1 p-3 p-md-4">
                    <div className="col-12 text-center mb-4">
                      <img src={forgotImg} className="w240 mb-4" alt="Change Password" />
                      <h1>Change Password</h1>
                      <span>Enter your current password and create a new one.</span>
                    </div>
                    <div className="col-12">
                      <div className="mb-2">
                        ...
                        />
                        <div className="mt-1">
                          <a href="/auth-password-reset.html" className="text-secondary small">
